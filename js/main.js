$(document).ready(function () {
	...
	$('.form__emojis span').on('click', function () {
		var value = $(this).data('value');
		$('#form__reaction').val(value);

		$('.form__emojis span').removeClass('active');
...
function showTrailer() {
	...
	$('#stats-section').hide();
	$('#btn-trailer').addClass('active');
	$('#btn-stats').removeClass('active');
}

function showStats() {
	$('#trailer-section').hide();
	$('#stats-section').show(); // Use flex if needed, or block
